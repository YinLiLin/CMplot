CMplot [![](https://img.shields.io/badge/Issues-%2B-brightgreen.svg)](https://github.com/YinLiLin/R-CMplot/issues) [![CRAN Version](https://www.r-pkg.org/badges/version/CMplot?color=red)](https://CRAN.R-project.org/package=CMplot) [![](https://img.shields.io/badge/GitHub-3.6.0-blueviolet.svg)]() ![](http://cranlogs.r-pkg.org/badges/grand-total/CMplot?color=green) [![](https://cranlogs.r-pkg.org/badges/last-month/CMplot?color=yellow)](https://CRAN.R-project.org/package=CMplot) [![Analytics](https://ga-beacon.appspot.com/UA-132438702-1/welcome-page)](https://github.com/YinLiLin/R-CMplot)
=========
