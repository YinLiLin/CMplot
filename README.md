CMplot [![](https://img.shields.io/badge/Issues-%2B-brightgreen.svg)](https://github.com/YinLiLin/R-CMplot/issues) [![CRAN Version](https://www.r-pkg.org/badges/version/CMplot?color=red)](https://CRAN.R-project.org/package=CMplot) ![](http://cranlogs.r-pkg.org/badges/grand-total/CMplot?color=green) [![](https://cranlogs.r-pkg.org/badges/last-month/CMplot)](https://CRAN.R-project.org/package=CMplot)
=========
